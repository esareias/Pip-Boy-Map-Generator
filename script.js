...
function getArchetype(name) {
    ...
    // --- MANUAL OVERRIDES (The "Don't Be Stupid" List) ---
    
    // Banks are buildings, not Vaults
    if (n.includes("BANK")) return 'COMMERCIAL'; 
    
    // Chem Dens are drug shops, not bear caves
    if (n.includes("CHEM")) return 'RETAIL'; 

    // Sniper Nests are military posts, not bug hives
    if (n.includes("SNIPER")) return 'BUNKER'; // or 'MILITARY' works too
...
function handleMouseMove(e) {
    // Calculate coordinates (Must be done every frame for tooltips/dragging)
    const rect = canvas.getBoundingClientRect();
    const scaleX = canvas.width / rect.width;
    const scaleY = canvas.height / rect.height;
    ...
    if (isPanning) {
        ...
        // V'S CRITICAL FIX: Divide by zoomLevel to ensure 1:1 mouse tracking while dragging
        mapOffsetX += dx / (RENDER_SCALE * zoomLevel);
        mapOffsetY += dy / (RENDER_SCALE * zoomLevel);

        // Clamp the view so you don't lose the map
    ...
    if (!hovering && data.labels) {
        for (let lbl of data.labels) {
            ...
            // Hit test based on logical position
...
const ITEM_DATABASE = {
    ...
    ruins: [
        ...
        {n: "Baseball Cap", v: 6}, 
        {n: "Turpentine", v: 8}, 
        {n: "Pre-War Casualwear", v: 8}, 
        {n: "Pre-War Money", v: 10}, 
        {n: "Lunchbox", v: 10}, 
        {n: "Dirty Water", v: 10}, 
        {n: "Vacuum Cleaner", v: 10}, 
        {n: "Paint Gun", v: 10}, 
        {n: "Cigarettes", v: 10}, 
        ...
        {n: "Mentats", v: 15}, 
        {n: "Nuka-Cola", v: 20}, 
        {n: "Raider Helmet", v: 20}, 
        {n: "Brass Knuckles", v: 20}, 
        {n: "Fission Battery", v: 20}, 
        {n: "Sensor Module", v: 20}, 
        {n: "Gas Tank", v: 25}, 
        {n: "Stimpak", v: 25}, 
        {n: "Molotov Cocktail", v: 25}, 
        {n: "Switchblade", v: 25}, 
        {n: "Police Baton", v: 25}, 
        {n: "Dynamite", v: 25}, 
        {n: "Psycho-D", v: 30}, 
        ...
        {n: "Leather Armor", v: 160}, 
        {n: "Raider Armor", v: 180}, 
        {n: "Laser Pistol", v: 200}, 
        {n: "Single Shotgun", v: 230}, 
        {n: "10mm Pistol", v: 250}, 
        {n: "9mm Submachine Gun", v: 260}, 
        {n: "10mm Submachine Gun", v: 300}, 
        {n: "Metal Armor", v: 320}, 

        // --- HIGH TIER (350+ caps) ---
        {n: "Sawed-Off Shotgun", v: 370}, 
        {n: "Combat Armor", v: 390}, 
        {n: "Chinese Assault Rifle", v: 500}, 
        {n: "Flamer", v: 500} 
    ],
    cave: [
