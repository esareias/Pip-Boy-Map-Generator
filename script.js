    ...
    if (!clicked && data.decorations) {
         for(let deco of data.decorations) {
              ...
              if (deco.x === gridX && deco.y === gridY && deco.type === 'radio') {
                   // MIX OF BIG APPLE PDF STATIONS + MOJAVE HOUSE ERA
                   const stations = [
                       { name: "Renegade Radio", msg: "🎵 'Renegades of Funk' plays... The DJ whispers: 'Stay dangerous, Big Apple.'" },
                       { name: "Voice of Coney", msg: "🎵 'Blitzkrieg Bop' blasts out... Happy Harry shouts!" },
                       { name: "Radio New Vegas", msg: "🎵 'Blue Moon' plays... 'This is Mr. New Vegas, reminding you that you're nobody 'til somebody loves you. And that somebody is me. I love you.'" },
                       { name: "House Frequency", msg: "🤖 'The Strip is secure. All securitrons active. Commerce is mandatory.'" },
                       { name: "Mojave Music Radio", msg: "🎵 'Big Iron' by Marty Robbins plays..." },
                       { name: "Jubilee Radio", msg: "🎵 'John Brown's Body' plays... (Coded Message: 4-9-15...)" }
                   ];
                   const station = stations[Math.floor(Math.random() * stations.length)];
                   log(`RADIO TUNED: [${station.name}] ${station.msg}`, 'var(--pip-amber)');
                   clicked = true;
              }
         }
    }
...
function filterItemsByLootFocus(pool, focus) {
    ...
    if (focus === "HIGH_VALUE") {
        return pool.filter(i => i.v >= 70 || i.n.includes("Mini-Nuke") || i.n.includes("Stealth Boy") || i.n.includes("Pip-Boy") || i.n.includes("Plasma") || i.n.includes("Mesmetron") || i.n.includes("Recharger"));
    }
    if (focus === "JUMPSUIT_GUNS") {
        return pool.filter(i => i.n.includes("Jumpsuit") || i.n.includes("Pistol") || i.n.includes("Armor") || i.n.includes("SMG") || i.n.includes("Rifle") || i.n.includes("Shotgun") || i.n.includes("Baton") || i.n.includes("Repeater"));
    }
    if (focus === "REPAIR_JUNK") {
        return pool.filter(i => i.n.includes("Duct Tape") || i.n.includes("Wonderglue") || i.n.includes("Turpentine") || i.n.includes("Scrap") || i.n.includes("Conductor") || i.n.includes("Sensor") || i.n.includes("Wrench"));
    }
    if (focus === "PAPER_JUNK") {
        return pool.filter(i => i.n.includes("Money") || i.n.includes("Book") || i.n.includes("Pin") || i.n.includes("Teddy") || i.n.includes("Toy") || i.n.includes("Poker Chip"));
    }
    if (focus === "MEDS") {
        return pool.filter(i => i.n.includes("Stimpak") || i.n.includes("Rad-X") || i.n.includes("RadAway") || i.n.includes("Doctor's Bag") || i.n.includes("Antivenom") || i.n.includes("Healing Powder") || i.n.includes("Poultice") || i.n.includes("Biogel") || i.n.includes("Fixer") || i.n.includes("Mentats") || i.n.includes("Cateye") || i.n.includes("Hydra") || i.n.includes("Turbo"));
    }
    if (focus === "LOW_CAPS") {
        return pool.filter(i => i.n.includes("Money") || i.n.includes("Poker Chip") || i.v < 10);
    }
    if (focus === "NUKA_COLA") {
        // Added Sunset, Sarsaparilla, Tequila, Whiskey, Vodka for Mojave drinks
        return pool.filter(i => i.n.includes("Nuka") || i.n.includes("Quantum") || i.n.includes("Sunset") || i.n.includes("Sarsaparilla") || i.n.includes("Rum") || i.n.includes("Beer") || i.n.includes("Buck Wild") || i.n.includes("Rot Gut") || i.n.includes("Jet") || i.n.includes("Psycho") || i.n.includes("Buffout") || i.n.includes("Tequila") || i.n.includes("Whiskey") || i.n.includes("Vodka"));
    }
    if (focus === "AMMO_EXP") {
        return pool.filter(i => i.n.includes("Dynamite") || i.n.includes("Molotov") || i.n.includes("Grenade") || i.n.includes("Mine") || i.n.includes("Pistol") || i.n.includes("Rifle") || i.n.includes("Shotgun") || i.n.includes("SMG") || i.n.includes("Mini-Nuke") || i.n.includes("Missile") || i.n.includes("Repeater") || i.n.includes("Revolver"));
    }
    if (focus === "FOOD_WATER" || focus === "SURVIVAL") {
        return pool.filter(i => i.n.includes("Water") || i.n.includes("Meat") || i.n.includes("Beans") || i.n.includes("Cram") || i.n.includes("Sugar Bombs") || i.n.includes("Fungus") || i.n.includes("Root") || i.n.includes("Flower") || i.n.includes("Gland") || i.n.includes("Gecko") || i.n.includes("Tobacco") || i.n.includes("Gourd") || i.n.includes("Mantis") || i.n.includes("Nightstalker") || i.n.includes("Fancy Lads"));
    }
        ...
        for (let y = 1; y < config.rows - 1; y++) {
            if (data.grid[x][y] === 1 && !isOccupied(data, x, y)) {
                ...
                if (Math.random() < chance) {
                    ...
                    // ⭐ BLUE STAR BOTTLE CAP SYSTEM (5% chance with Sunset Sarsaparilla)
                    const lastItem = contentArray[contentArray.length - 1];
                    if (lastItem.n === "Sunset Sarsaparilla" && Math.random() < 0.05) {
                        contentArray.push({ n: "Blue Star Bottle Cap", v: 0, rarity: "LEGENDARY" });
                    }
...
const ITEM_DATABASE = {
    // -------------------------------------------------------------------------
    // VAULT: High-Tech, Medical, Clean Pre-War Gear, Energy Weapons
    // Big Apple PDF + House/Mojave Tech
    // -------------------------------------------------------------------------
    vault: [
        // Utility & Junk
        {n: "Bobby Pin", v: 1}, {n: "Pre-War Money", v: 10}, {n: "Sensor Module", v: 20},
        {n: "Fission Battery", v: 20}, {n: "Conductor", v: 15}, {n: "Scrap Electronics", v: 5},
        {n: "Abraxo Cleaner", v: 5}, {n: "Turpentine", v: 8}, {n: "Wonderglue", v: 15},
        {n: "Egg Timer", v: 6}, {n: "Wrench", v: 5}, {n: "Surgical Tubing", v: 5},
        {n: "Poker Chip", v: 1}, {n: "Platinum Chip Replica", v: 50}, // House Flavor

        // Apparel
        {n: "Vault Jumpsuit", v: 8}, {n: "Armored Vault Jumpsuit", v: 200},
        {n: "Vault Security Armor", v: 70}, {n: "Vault Lab Uniform", v: 8},
        {n: "Pip-Boy 3000", v: 1000}, 

        // Meds & Chems
        {n: "Stimpak", v: 25}, {n: "RadAway", v: 35}, {n: "Rad-X", v: 5},
        {n: "Mentats", v: 15}, {n: "Fixer", v: 25}, {n: "Doctor's Bag", v: 25},
        {n: "Auto-Inject Stimpak", v: 35}, {n: "Super Stimpak", v: 50},
        {n: "Alien Biogel", v: 25}, {n: "Cateye", v: 10}, 

        // Weapons
        {n: "Laser Pistol", v: 200}, {n: "10mm Pistol", v: 250}, {n: "Police Baton", v: 25},
        {n: "Ripper", v: 100}, {n: "Plasma Rifle", v: 1200}, {n: "Mesmetron", v: 500},
        {n: "Shock Baton", v: 70}, {n: "Pulse Grenade", v: 60}, {n: "Recharger Rifle", v: 800}
    ],

    // -------------------------------------------------------------------------
    // RUINS: The Big Apple Grit + Mojave Drinks
    // -------------------------------------------------------------------------
    ruins: [
        // Junk & Food
        {n: "Tin Can", v: 1}, {n: "Empty Bottle", v: 1}, {n: "Scrap Metal", v: 5},
        {n: "Duct Tape", v: 5}, {n: "Lunchbox", v: 10}, {n: "Nuka-Cola", v: 20},
        {n: "Nuka-Cola Quantum", v: 100}, {n: "Cram", v: 5}, {n: "Pork n Beans", v: 5},
        {n: "Sugar Bombs", v: 5}, {n: "Dirty Water", v: 10}, {n: "Purified Water", v: 20},
        {n: "Pre-War Book", v: 5}, {n: "Teddy Bear", v: 5}, {n: "Toy Car", v: 5},
        {n: "Sunset Sarsaparilla", v: 10}, {n: "Fancy Lads Snack Cakes", v: 5},

        // Booze & Chems (Big Apple Specials + Mojave Standards)
        {n: "Roentgen Rum", v: 15}, {n: "Gamma Gulp Beer", v: 3}, {n: "Buck Wild 20/20", v: 25},
        {n: "Rot Gut", v: 10}, {n: "Jet", v: 5}, {n: "Psycho", v: 15}, {n: "Buffout", v: 15},
        {n: "Whiskey", v: 10}, {n: "Vodka", v: 10}, {n: "Wasteland Tequila", v: 20},

        // Weapons & Ammo
        {n: "10mm SMG", v: 300}, {n: ".44 Magnum", v: 230}, {n: "Sawed-Off Shotgun", v: 370},
        {n: "Chinese Assault Rifle", v: 500}, {n: "Hunting Rifle", v: 320}, {n: "Flamer", v: 500},
        {n: "Frag Grenade", v: 75}, {n: "Molotov Cocktail", v: 25}, {n: "Bottlecap Mine", v: 75},
        {n: "Mini-Nuke", v: 250}, {n: "Missile", v: 50}, {n: "Cowboy Repeater", v: 400},
        {n: "Dynamite", v: 25}, {n: ".357 Magnum Revolver", v: 120},

        // Apparel
        {n: "Raider Armor", v: 180}, {n: "Leather Jacket", v: 50}, {n: "Metal Armor", v: 320},
        {n: "Combat Armor", v: 390}, {n: "Pre-War Hat", v: 6}, {n: "Gas Mask", v: 20},
        {n: "Merc Outfit", v: 50}, {n: "Cowboy Hat", v: 10}
    ],

    // -------------------------------------------------------------------------
    // CAVE: Tribal/Natural (Big Apple Flora + Mojave Fauna)
    // -------------------------------------------------------------------------
    cave: [
        // Natural & Survival
        {n: "Broc Flower", v: 3}, {n: "Xander Root", v: 3}, {n: "Cave Fungus", v: 3},
        {n: "Mole Rat Meat", v: 5}, {n: "Yao Guai Meat", v: 30}, {n: "Deathclaw Hand", v: 45},
        {n: "Radscorpion Gland", v: 15}, {n: "Hollow Rock Stash", v: 0}, 
        {n: "Gecko Meat", v: 5}, {n: "Coyote Tobacco Chew", v: 5}, {n: "Buffalo Gourd Seed", v: 2},
        {n: "Mantis Foreleg", v: 5}, {n: "Nightstalker Blood", v: 20},

        // Tribal Meds
        {n: "Healing Powder", v: 5}, {n: "Antivenom", v: 5}, {n: "Poultice", v: 5},
        {n: "Datura Root", v: 5}, {n: "Hydra", v: 40}, {n: "Turbo", v: 30},

        // Weapons
        {n: "Machete", v: 50}, {n: "Spear", v: 20}, {n: "Sledgehammer", v: 130},
        {n: "Deathclaw Gauntlet", v: 150}, {n: "Combat Knife", v: 40}, {n: "Brass Knuckles", v: 20},
        {n: "Dynamite", v: 25}, {n: "Throwing Spear", v: 20},

        // Apparel
        {n: "Tribal Garb", v: 6}, {n: "Raider Badlands Armor", v: 180}
    ]
};
